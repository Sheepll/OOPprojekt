...
public class  M2ng extends Application {
    ...
    public void start(Stage primaryStage) throws InterruptedException {
        ...
        while (nimeluger < nimed.length) {
            ...
            Image vpilt = new Image("default.png");
            ...
            timeline.getKeyFrames().add(new KeyFrame(Duration.ZERO, actionEvent -> {
                Image temp = new Image(vastane.getNimi() + ".jpg");
                pilt.setImage(temp);
            ...
            timeline.getKeyFrames().add(new KeyFrame(Duration.seconds(11), actionEvent -> {
               ...
               if(otsus == -1){
                ...
                M2ng loop = new M2ng(m2ngija,vastane,nimed,nimeluger,logi);
                try {
                    loop.start(primaryStage);
